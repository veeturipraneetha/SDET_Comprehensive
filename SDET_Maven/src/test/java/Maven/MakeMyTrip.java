...
@Test
		public void bookingfights() throws Exception {
		...
		WebElement startdate = driver.findElement(By.xpath("//div[@aria-label= 'Tue May 21 2024']"));
		startdate.click();
		Thread.sleep(3000);

		WebElement enddate = driver.findElement(By.xpath("//div[@aria-label='Sun May 26 2024']"));
		enddate.click();
		Thread.sleep (3000);
